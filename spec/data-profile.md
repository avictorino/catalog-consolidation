...
it has already produced. `consolidation.schema.classify_source` inspects the table
...
helpers in `consolidation.schema`. Staged tables are built alongside the originals
